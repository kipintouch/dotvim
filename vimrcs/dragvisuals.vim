...
" Preserve external compatibility options,                " {{{2
" then enable full vim compatibility...
let s:save_cpo = &cpo
set cpo&vim

" Toggle this to stop trimming on drags...                " {{{1
...
" Drag in specified direction in Visual Block mode...     " {{{1
